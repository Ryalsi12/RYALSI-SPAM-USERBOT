...
from telethon.utils import admin_cmd
from telethon.Config import Config
from telethon.cmdhelp import CmdHelp
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Ryalsi12/RYALSI-SPAM-USERBOT"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "| UPDATED UR RYALSI SIR | TYPE PING ELSE ' I AM GEY ' "
    )
